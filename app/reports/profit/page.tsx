...
export default function ProfitReportPage() {
  return (
    <ReportPageShell
      ...
      description="Analyze posted accounting revenue, Cost of Goods Sold, operating expenses, margins and net profit."
      icon="💰"
    >
      <ProfitReportContent />
    </ReportPageShell>
...
function ProfitReportContent() {
  ...
  return (
    <div className="min-w-0 space-y-6">
      ...
      <section className="mt-6 rounded-3xl border border-violet-100 bg-white p-4 shadow-lg sm:mt-8 sm:p-6">
      ...
      <section className="mt-6 min-w-0 overflow-hidden rounded-3xl border border-violet-100 bg-white shadow-xl sm:mt-8">
                      ...
                      <div className="min-w-0">
                        {canViewSales ? (
                          <Link
                            ...
                            className="block truncate text-lg font-bold text-violet-700 transition hover:text-violet-800 hover:underline"
                          >
                            {row.invoiceNumber}
                          </Link>
                        ) : (
                    ...
                    >
                      <td className="px-6 py-5">
                        {canViewSales ? (
                          <Link
                            href={`/sales/invoice/${row.id}`}
                            className="font-bold text-violet-700 transition hover:text-violet-800 hover:underline"
                          >
                            {row.invoiceNumber}
                          </Link>
                        ) : (

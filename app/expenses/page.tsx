            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div className="max-w-3xl">
                ...
                <p className="mt-3 max-w-2xl text-base leading-7 text-violet-100 sm:text-lg">
                  Track rent, salary, transport, utilities and other operating
                  costs from one permission-aware workspace.
                </p>
              </div>
          ...
          {isPermissionLoading ? (
            ...
            <section className="mt-6 rounded-3xl border border-red-200 bg-white p-6 text-center shadow-xl sm:p-10">
              ...
              <h2 className="mt-5 text-2xl font-black text-slate-900">
                Expenses Access Restricted
              </h2>

              <p className="mx-auto mt-3 max-w-2xl leading-7 text-slate-600">
                Your current role does not include the expenses.view
            ...
            <>
              {!hasWriteAccess && (
                <div className="mt-6 rounded-2xl border border-violet-200 bg-violet-50 px-5 py-4 text-violet-900">
                  <p className="font-black">Read-only expense access</p>
                  <p className="mt-1 text-sm leading-6 text-violet-700">
                    You can review expense history. Create, edit and delete
